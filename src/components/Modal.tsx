  ...
  const { currentScore } = useContext(AppContext);
    ...
    return (
      <div className="fixed top-0 right-0 w-full h-full bg-gray-800 bg-opacity-50  z-10 duration-1000 transition-all">
        ...
        <p className=" bg-gray-700 w-[50%] text-gray-50 p-4  rounded-lg text-center">Game Over !</p>
        <p className=" bg-gray-700 w-[50%] text-gray-50 p-4  rounded-lg text-center">Your Score: {currentScore}</p>
